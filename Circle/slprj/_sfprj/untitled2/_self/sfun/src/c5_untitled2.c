...
static void c5_info_helper(const mxArray **c5_info)
{
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[E]/Users/dittoyi/DittoyiWorkSystem/scholar/OnGoingWork/PathFollowingRRS/Circle/container.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1417700280U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_SCRIPT_FCN(0,0,"container",0,-1,7339);
...
static void mdlSetWorkWidths_c5_untitled2(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(688516937U));
  ssSetChecksum1(S,(982892085U));
  ssSetChecksum2(S,(728993514U));
  ssSetChecksum3(S,(2726735267U));
