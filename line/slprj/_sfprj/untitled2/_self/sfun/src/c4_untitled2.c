...
static const char * c4_debug_family_names[11] = { "x", "y", "x_dot", "y_dot",
  "nargin", "nargout", "m", "Dis_Path_o", "R_po", "r_c", "Theta_po" };
...
static void sf_gateway_c4_untitled2(SFc4_untitled2InstanceStruct *chartInstance)
{
  ...
  int32_T c4_i4;
  int32_T c4_i5;
  static real_T c4_dv2[4] = { 0.89442719099991586, -0.44721359549995793,
  ...
  _SFD_DATA_RANGE_CHECK(*c4_b_m, 0U);
  chartInstance->c4_sfEvent = CALL_EVENT;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_x, 0U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_y, 1U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_x_dot, 2U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_y_dot, 3U, c4_sf_marshallOut);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_nargout, 5U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_m, 6U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_Dis_Path_o, 7U, c4_c_sf_marshallOut,
    c4_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_R_po, 8U, c4_b_sf_marshallOut,
    c4_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_r_c, 9U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_Theta_po, 10U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c4_Theta_po = 0.46364760900080609;
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, -23);
  _SFD_SYMBOL_SCOPE_POP();
  for (c4_i6 = 0; c4_i6 < 2; c4_i6++) {
    (*c4_b_Dis_Path_o)[c4_i6] = c4_Dis_Path_o[c4_i6];
  }

  for (c4_i7 = 0; c4_i7 < 4; c4_i7++) {
    (*c4_b_R_po)[c4_i7] = c4_R_po[c4_i7];
  }
  ...
  *c4_b_Theta_po = c4_Theta_po;
  ...
  for (c4_i8 = 0; c4_i8 < 2; c4_i8++) {
    _SFD_DATA_RANGE_CHECK((*c4_b_Dis_Path_o)[c4_i8], 1U);
  }

  for (c4_i9 = 0; c4_i9 < 4; c4_i9++) {
    _SFD_DATA_RANGE_CHECK((*c4_b_R_po)[c4_i9], 2U);
  }

  _SFD_DATA_RANGE_CHECK(*c4_b_r_c, 3U);
  _SFD_DATA_RANGE_CHECK(*c4_b_Theta_po, 4U);
}
  ...
  *c4_inData)
{
  ...
  for (c4_i11 = 0; c4_i11 < 2; c4_i11++) {
    for (c4_i12 = 0; c4_i12 < 2; c4_i12++) {
      c4_b_inData[c4_i12 + c4_i10] = (*(real_T (*)[4])c4_inData)[c4_i12 + c4_i10];
    }
  ...
  for (c4_i14 = 0; c4_i14 < 2; c4_i14++) {
    for (c4_i15 = 0; c4_i15 < 2; c4_i15++) {
      c4_u[c4_i15 + c4_i13] = c4_b_inData[c4_i15 + c4_i13];
    }
  ...
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[4])
{
  ...
  int32_T c4_i16;
  (void)chartInstance;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_u), c4_dv3, 1, 0, 0U, 1, 0U, 2, 2, 2);
  for (c4_i16 = 0; c4_i16 < 4; c4_i16++) {
    c4_y[c4_i16] = c4_dv3[c4_i16];
  }
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  for (c4_i18 = 0; c4_i18 < 2; c4_i18++) {
    for (c4_i19 = 0; c4_i19 < 2; c4_i19++) {
      (*(real_T (*)[4])c4_outData)[c4_i19 + c4_i17] = c4_y[c4_i19 + c4_i17];
    }
  ...
  *c4_inData)
{
  ...
  for (c4_i20 = 0; c4_i20 < 2; c4_i20++) {
    c4_b_inData[c4_i20] = (*(real_T (*)[2])c4_inData)[c4_i20];
  }
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  for (c4_i23 = 0; c4_i23 < 2; c4_i23++) {
    (*(real_T (*)[2])c4_outData)[c4_i23] = c4_y[c4_i23];
  }
...
static void c4_info_helper(const mxArray **c4_info)
{
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("sign"), "name", "name", 26);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 26);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("atan"), "name", "name", 29);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 29);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1111425618U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1733916645U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2142773946U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2825655500U);
}
...
mxArray *sf_c4_untitled2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("J2hus6UYRiE5ecnyw96zRC");
...
static void mdlSetWorkWidths_c4_untitled2(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3235599614U));
  ssSetChecksum1(S,(2523635605U));
  ssSetChecksum2(S,(1952621323U));
  ssSetChecksum3(S,(750289907U));
