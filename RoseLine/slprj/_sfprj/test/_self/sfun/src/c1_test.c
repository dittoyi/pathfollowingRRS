...
static real_T c1_emlrt_marshallIn(SFc1_testInstanceStruct *chartInstance, const
  mxArray *c1_b_u_last, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_testInstanceStruct *chartInstance,
...
static real_T c1_d_emlrt_marshallIn(SFc1_testInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_e_emlrt_marshallIn(SFc1_testInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
  ...
  *chartInstance)
{
  ...
  c1_c_hoistedGlobal = chartInstance->c1_is_active_c1_test;
  ...
  mxArray *c1_st)
{
  ...
  *c1_ui = c1_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u,
  ...
  chartInstance->c1_is_active_c1_test = c1_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 2)), "is_active_c1_test");
  sf_mex_destroy(&c1_u);
...
static void sf_c1_test(SFc1_testInstanceStruct *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK(*c1_b_ui, 1U);
  ...
  sf_debug_symbol_scope_add_eml(&c1_delta_max, 0U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_Ddelta_max, 1U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c1_delta_dot, 2U,
  ...
  sf_debug_symbol_scope_add_eml_importable(&c1_nargout, 4U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c1_u, 5U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c1_b_h, 6U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_ui, 7U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&chartInstance->c1_u_last, 8U,
  ...
  if (CV_EML_IF(0, 1, 1, c1_y >= 0.69813170079773179)) {
    ...
    c1_b_y = c1_a * 40.0;
    c1_b_a = c1_b_y;
    c1_c_y = c1_b_a * 3.1415926535897931;
    c1_A = c1_c_y;
    c1_e_x = c1_A;
    c1_f_x = c1_e_x;
    c1_ui = c1_f_x / 180.0;
  ...
  c1_h_x = c1_g_x;
  c1_e_y = c1_d_y;
  c1_delta_dot = c1_h_x / c1_e_y;
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 18);
  c1_i_x = c1_delta_dot;
  c1_j_x = c1_i_x;
  c1_f_y = muDoubleScalarAbs(c1_j_x);
  if (CV_EML_IF(0, 1, 2, c1_f_y >= 0.087266462599716474)) {
    ...
    c1_h_y = c1_d_a * 5.0;
    c1_e_a = c1_h_y;
    c1_i_y = c1_e_a * 3.1415926535897931;
    c1_c_A = c1_i_y;
    c1_m_x = c1_c_A;
    c1_n_x = c1_m_x;
    c1_j_y = c1_n_x / 180.0;
    c1_ui = c1_j_y + chartInstance->c1_u_last;
  }
...
const mxArray *sf_c1_test_get_eml_resolved_functions_info(void)
{
  ...
  (*c1_b_info)[3].fileTimeLo = 1342789344U;
  (*c1_b_info)[3].fileTimeHi = 0U;
  (*c1_b_info)[3].mFileTimeLo = 1319708366U;
  ...
  (*c1_b_info)[4].fileTimeLo = 1286797244U;
  ...
  const mxArray *c1_b_is_active_c1_test, const char_T *c1_identifier)
{
  ...
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_y = c1_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_b_is_active_c1_test),
    &c1_thisId);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2283793997U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1718193427U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4171931498U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3222741442U);
}
...
mxArray *sf_c1_test_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("VGlRhbeEw6BCnuC2BlltSG");
...
static const mxArray *sf_get_sim_state_info_c1_test(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"ui\",},{M[4],M[0],T\"u_last\",S'l','i','p'{{M1x2[45 51],M[0],}}},{M[8],M[0],T\"is_active_c1_test\",}}"
  };
...
static void mdlSetWorkWidths_c1_test(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3201988808U));
  ssSetChecksum1(S,(2812718512U));
  ssSetChecksum2(S,(2134932982U));
  ssSetChecksum3(S,(1251535424U));
