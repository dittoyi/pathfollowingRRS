  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_ww, 0U, c4_sf_marshallOut);
  ...
  c4_fb_x = c4_eb_x;
  c4_d_y = c4_c_y;
  c4_e_y = c4_fb_x / c4_d_y;
  c4_gb_x = c4_mpower(chartInstance, c4_x_dot) + c4_mpower(chartInstance,
    c4_y_dot);
  c4_hb_x = c4_gb_x;
  if (c4_hb_x < 0.0) {
    c4_eml_error(chartInstance);
  ...
  c4_hb_x = muDoubleScalarSqrt(c4_hb_x);
  c4_b_A = c4_y_dot;
  c4_b_B = c4_hb_x;
  c4_ib_x = c4_b_A;
  c4_f_y = c4_b_B;
  ...
  c4_kb_x = c4_jb_x;
  c4_h_y = c4_g_y;
  c4_i_y = c4_kb_x / c4_h_y;
  c4_lb_x = c4_mpower(chartInstance, c4_x_dot) + c4_mpower(chartInstance,
    c4_y_dot);
  c4_mb_x = c4_lb_x;
  if (c4_mb_x < 0.0) {
    c4_eml_error(chartInstance);
  ...
  c4_pb_x = c4_ob_x;
  c4_l_y = c4_k_y;
  c4_m_y = c4_pb_x / c4_l_y;
  c4_qb_x = c4_mpower(chartInstance, c4_x_dot) + c4_mpower(chartInstance,
    c4_y_dot);
  c4_rb_x = c4_qb_x;
  if (c4_rb_x < 0.0) {
    c4_eml_error(chartInstance);
  ...
  c4_rb_x = muDoubleScalarSqrt(c4_rb_x);
  c4_d_A = c4_x_dot;
  c4_d_B = c4_rb_x;
  c4_sb_x = c4_d_A;
  c4_n_y = c4_d_B;
  ...
  c4_ub_x = c4_tb_x;
  c4_p_y = c4_o_y;
  c4_q_y = c4_ub_x / c4_p_y;
  c4_R_po[0] = c4_e_y;
  c4_R_po[2] = c4_i_y;
  c4_R_po[1] = c4_m_y;
  c4_R_po[3] = c4_q_y;
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 22);
  c4_vb_x = c4_mpower(chartInstance, c4_x_dot) + c4_mpower(chartInstance,
    c4_y_dot);
  c4_r_c = c4_vb_x;
  if (c4_r_c < 0.0) {
    c4_eml_error(chartInstance);
  ...
  c4_xb_x = c4_y_dot;
  c4_yb_x = c4_xb_x;
  c4_r_y = muDoubleScalarAbs(c4_yb_x);
  c4_ac_x = c4_r_y;
  c4_bc_x = c4_ac_x;
  ...
  c4_fc_x = c4_x_dot;
  c4_gc_x = c4_fc_x;
  c4_gc_x = muDoubleScalarSign(c4_gc_x);
  c4_hc_x = c4_y_dot;
  c4_ic_x = c4_hc_x;
  c4_ic_x = muDoubleScalarSign(c4_ic_x);
  c4_f_A = c4_s_y * (1.0 - c4_gc_x) * c4_ic_x * 3.1415926535897931;
  c4_jc_x = c4_f_A;
  c4_kc_x = c4_jc_x;
  c4_lc_x = c4_kc_x;
  c4_t_y = c4_lc_x / 2.0;
  ...
  c4_oc_x = c4_nc_x;
  c4_w_y = c4_v_y;
  c4_x_y = c4_oc_x / c4_w_y;
  c4_pc_x = c4_x_y;
  c4_qc_x = c4_pc_x;
  c4_qc_x = muDoubleScalarAtan(c4_qc_x);
  c4_Theta_po = c4_t_y + c4_qc_x;
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, -24);
  _SFD_SYMBOL_SCOPE_POP();
...
static void c4_info_helper(const mxArray **c4_info)
{
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("mpower"), "name", "name", 11);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 11);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 13);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("ismatrix"), "name", "name", 13);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 13);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 14);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("power"), "name", "name", 14);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 14);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m!fltpower"), "context",
                  "context", 20);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("floor"), "name", "name", 20);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 20);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("sqrt"), "name", "name", 24);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 24);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2092011985U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1169147422U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1594491721U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4081748725U);
}
...
mxArray *sf_c4_untitled2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("zZVwnikbTWZS8KmlDxoeWD");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1103);
...
static void mdlSetWorkWidths_c4_untitled2(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2358077219U));
  ssSetChecksum1(S,(1974777644U));
  ssSetChecksum2(S,(2282326592U));
  ssSetChecksum3(S,(1780181097U));
