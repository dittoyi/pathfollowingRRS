  ...
  c5_chartNumber, uint32_T c5_instanceNumber)
{
  ...
  _SFD_SCRIPT_TRANSLATION(c5_chartNumber, c5_instanceNumber, 0U,
    ...
    "/Users/dittoyi/DittoyiWorkSystem/scholar/OnGoingWork/PathFollowingRRS/RoseLine/container.m"));
}
...
static void mdlSetWorkWidths_c5_untitled2(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2134496085U));
  ssSetChecksum1(S,(2857282090U));
  ssSetChecksum2(S,(770982703U));
  ssSetChecksum3(S,(3949571838U));
